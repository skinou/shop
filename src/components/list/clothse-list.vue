<template>
  <div v-show="clothesList.length"  class="content">
...
<script>
    ...
    export default {
      ...
      computed: {
        ...
        // },
        brands () {
          return this.$store.getters.clothesBrands
        },
        colors () {
          return this.$store.getters.clothesColors
        },
        classifications () {
          return this.$store.getters.clothesClassifications
        },
        filteredAndOrderedList () {
          let list = [...this.clothesList]
          // 按品牌过滤
          if (this.filterBrand !== '') {
      ...
      // created () {
      //   this.clothesData =  [...this.clothesList]
      // },
      data () {
        return {
          filterBrand: '',
